...
export function DeleteArtistDialog({ artist, onConfirm, onCancel }: DeleteArtistDialogProps) {
  return (
      ...
      <div className="bg-[#1A1A1A] rounded-2xl border border-white/10 w-full max-w-sm mx-4 p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-white">Hapus Artis</h2>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="bg-[#0F0F0F] rounded-lg border border-white/10 p-3 mb-4">
          <p className="text-xs text-zinc-500 mb-0.5">Artist ID</p>
          <p className="text-xs font-mono text-zinc-300">{artist.artist_id}</p>
          <p className="text-xs text-zinc-500 mt-2 mb-0.5">Nama</p>
