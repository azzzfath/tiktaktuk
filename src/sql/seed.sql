...
INSERT INTO administrator (administrator_id, full_name, phone_number, user_id)
VALUES
  ('44444444-2222-0000-0000-000000000001', 'Administrator Demo', '080000000000', '22222222-1111-0000-0000-000000000001')
ON CONFLICT (user_id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  phone_number = EXCLUDED.phone_number;
